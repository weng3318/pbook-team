...
const Controls = React.createClass({
  ...
  render() {
    return (
      <div>
        <svg className="controls controls-top" id="touch-controls" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.8 101.5" aria-labelledby="title">
          <title id="controls">controls</title>
          <rect x="120.2" y="44.7" width="59.3" height="49.21" rx="15" ry="15" transform="rotate(-180 146.45 66.7)" fill="#006666" />
            <g id="up" onClick={this._elephantDirection.bind(this, "up")}><path fill="#fff" d="M150.9 49.5l-7.1-4.6-7.1 4.6h2.9V57h6.2v-7.5h5.1z"/><path d="M138.7 50.4h-4.4L144 44l8.4 5.5-1.4.9h-3.1v6.5l-1.4.9h-7.8zm-1.3-.9h2.6v7.4h5.2v-7.4h2.6l-5.2-3.4z" fill="#000"/></g>
            <g id="right" onClick={this._elephantDirection.bind(this, "right")}><path fill="#fff" d="M160.8 71.6l4.6-7.5-4.6-7.6v3.1h-7.5v6.6h7.5v5.4z"/><path d="M159.9 58.6v-4.7l6.4 10.4-5.5 8.9-.9-1.5v-3.2h-6.5l-.9-1.5v-8.4zm.9-1.4V60h-7.4v5.6h7.4v2.8l3.4-5.6z" fill="#000"/></g>
            <g id="down" onClick={this._elephantDirection.bind(this, "down")}><path fill="#fff" d="M150.9 78l-7.1 4.6-7-4.6h2.9v-7.5h6.2V78h5z"/><path d="M138.8 69.7h7.7l1.4.9v6.5h3l1.4.9-8.3 5.5-9.7-6.4h4.4zm3.9 11.7l5.2-3.4h-2.6v-7.4h-5.2V78h-2.6z" fill="#000"/></g>
            <g id="left" onClick={this._elephantDirection.bind(this, "left")}><path fill="#fff" d="M126.2 71.6l-4.7-7.5 4.7-7.6v3.1h7.4v6.6h-7.4v5.4z"/><path d="M134.4 58.6v8.3l-.9 1.5H127v3.3l-.9 1.5-5.5-8.9 6.4-10.4v4.8zm-11.7 4.2l3.4 5.6v-2.8h7.4V60h-7.4v-2.8z" fill="#000"/></g>
        </svg>
        <div className="elephantContainer" ref="elContainer">
          <Elephant />
          <div className="deWow wow" ref="deWow"></div>
          <div className="inWow wow" ref="inWow"></div>
          <div className="mWow wow" ref="mWow"></div>
        </div>
        <div className="tacoContainer" ref="tContainer">
          <div className="taco" ref="taco"></div>
        </div>
        <div className="margaritaContainer" ref="mContainer">
          <div className="margarita" ref="margarita"></div>
        </div>
        <div className="textContainer" ref="txContainer">
          <Text ref="textmessages"/>
        </div>
        <div className="overlay overlayMargarita" ref="overlayM"></div>
      </div>
    )
  }
}); 
...
const Text = React.createClass({
  ...
  render() {
    return (
      <svg className="text" width="65.9" height="80.6" viewBox="0 0 65.9 80.6" role="presentation">
        <path ref="bkText" fill="#d16f43" d="M.4 7.4H46v62.47H.4z"/>
        <path fill="#fcfbfa" d="M27.5 29.8h33v13.75h-33z"/>
        <path fill="#e2dfd8" d="M17.2 69.8h13.4v10.79H17.2z"/>
...
const Elephant = React.createClass({
  render() {
    return (
      <svg className="elephant" xmlns="http://www.w3.org/2000/svg" viewBox="15 15 255 130">
        <path id="ear-right" className="st0" d="M173.9 62s58.7-16.7 68.3-32.3c9.7-15.7 19.7-11 18-2.7-1.7 8.3-40 49.3-49.7 47.7-9.7-1.7-27.7 7.1-31 0-3.2-7-15.7-9-5.6-12.7z"/>
        <path className="st1" d="M154.1 117.3s16.5 6.9 18.5 11.2c2 4.2 1.5 6 3.5 5.8s11.2-5.8 8-12.9-23-24.9-28.8-17.4-6.2 12.4-1.2 13.3z"/>
        <ellipse className="st0" cx="130.8" cy="88.7" rx="35.2" ry="28.7"/>
        <ellipse className="st2" cx="87.4" cy="92.8" rx="10.8" ry="4.2"/>
        <path className="st1" d="M208.3 104.6c0 .3-.1.5-.4.6l-16.1 2.8c-.3 0-.5-.1-.6-.4l-2.3-12.3c0-.3.1-.5.5-.6l16-3.8h.1c.1 0 .2.1.3.1.1 0 .2.1.2.3l2.3 13.3z"/>
        <path className="st1" d="M245.4 85.4c-.3-1.3-.8-2.5-1.7-3.6-2.7-3.3-7.4-3.9-10.3-1.5-3 2.5-3.2 7.1-.5 10.4 2.2 2.6 5.6 3.6 8.4 2.6v.3c1 13-14.1 6.7-14.1 6.7-.2-.6-.4-1.2-.6-1.7l-2.2.7c-.5-.6-1.1-1.1-1.9-1.5l3.1-1c-.9-1.2-2.2-2.2-4.1-3.2.1-.8.1-2.7.1-3.5v-.8l-5.3.4c-.2 0-.5.2-.6.4-.2.2-.2.5-.2.8l1.1 6.4c-.7.2-1.3.5-1.9.9l-.7-3.8-4.3 1.2 1.5 8.4c.3 1.9-.9 3.7-2.8 4l-16.1 2.8h-.6c-1.7 0-3.2-1.2-3.5-2.9l-2.3-12.3c-.3-1.9.9-3.7 2.8-4.1l16-3.8c1-.2 1.9 0 2.7.6.8.5 1.3 1.3 1.4 2.3l.5 3 4.3-1.2-.2-1.2c-.1-.8 0-1.6.5-2.2.5-.7 1.2-1.1 1.9-1.2h.1l5.4-.4c-.5-5.2-2.5-10-5.6-14.2-2.9-3.9-6.8-7.2-11.3-9.8-5.5-3-11.9-4.9-18.8-5.1H184c-10.8 0-20.5 3.8-27.3 10-.2.2-.4.3-.5.5-5.2 4.9-8.6 11.1-9.4 17.9-.1 1.1-.2 2.2-.2 3.3-1.3 2.2-1.7 4.7-1.5 7.5.2 2.1.8 4.4 1.8 6.6 1 2.3 2.5 4.5 4.4 6.6.2.3.5.5.7.8.7.8 1.6 1.5 2.4 2.3l.3.3c4 3.3 8.5 5.2 12.7 5.9 4.6 2.4 10.6 4.2 17.4 4.9.7.1 1.4.1 2.2.2 10 .7 19-1.2 24.7-4.6 1.9-.5 3.8-1.3 5.5-2.1 1.2-.6 2.4-1.3 3.4-2 8.2 3.5 17.8 3.1 17.8 3.1 21.3-.2 13-24.1 7-34.1z"/>
        <path className="st2" d="M120.9 116.5s-20.3-44.5-7.5-52.8c0 0-65.1 26.3 7.5 52.8z"/>
        <ellipse className="st2" cx="87.8" cy="99.8" rx="19.2" ry="7.8"/>
        <path className="st2" d="M204.8 63.6s-20.1-29.6-44-11.9c0 0-3.9-3.3-7.3 3.3-4 7.9-5.1 7.3-5.1 7.3s-6-4.2-6.9 10.5c-.8 14.7-15.7 22.5-4.8 26.2 10.8 3.7 31.8-23.7 31.8-23.7s19.7-16.8 36.3-11.7z"/>
        <path id="ear-left" className="st0" d="M160.3 68.7S111.6 63 64 78.4c0 0-31.3 5.7-35 0 0 0-18.7-5.3-5.7 5.2 0 0 20.3 15.8 55.3 16s60.7-11.2 60.7-11.2l23.7-4.8c-.1-.1 23.3-13.9-2.7-14.9z"/>
        <g id="eyes">
          <ellipse className="st3" cx="200.7" cy="99.5" rx="2.2" ry="4.5"/>
          <ellipse className="st3" cx="219.1" cy="94.4" rx=".8" ry="2.6"/>
        </g>
        <path className="st4" d="M217.1 118.3s-14.5 2-16.3-4M205.3 110.7s2 6-10.7 3.8"/>
        <path className="st1" d="M162.3 129s-4.2-.8-6-8c-1.8-7.2-2-18-13-17s-12.5 8.8-12.5 8.8-4 6.7 7.5 17.2c0 0 2.7 1.8 3.6 6.5 1.5 8.1 20.4-7.5 20.4-7.5z"/>
        <ellipse transform="rotate(-20.12 152.072 132.685)" className="st1" cx="152.1" cy="132.7" rx="10.9" ry="6.7"/>
